...
add_arg("base_model",    type=str, default="whisper-large-v2/",      help="Whisper的基础模型")
...
add_arg("num_workers",   type=int, default=0,       help="读取数据的线程数量")
...
add_arg("num_train_epochs", type=int, default=1,      help="训练的轮数")
add_arg("language",      type=str, default=None, help="设置语言,可全称也可简写,如果为None则训练的是多语言")
add_arg("task",     type=str, default="translate", choices=['transcribe', 'translate'], help="模型的任务")
